...
var httpServer = _http["default"].createServer(_server["default"]);
/**
...
function onError(error) {
  ...
  switch (error.code) {
    case 'EACCES':
      log.info("".concat(bind, " requires elevated privileges"));
      process.exit(1);
      break;

    case 'EADDRINUSE':
      log.info("".concat(bind, " is already in use"));
      process.exit(1);
      break;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return _database.db.sequelize.authenticate();
